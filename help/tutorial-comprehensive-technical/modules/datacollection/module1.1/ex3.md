...
Bienvenue dans le SDK web de Adobe Experience Platform ! Ici, vous pouvez configurer l’extension avec le flux de données que vous avez créé dans [Prise en main](./../../../modules/gettingstarted/gettingstarted/ex2.md) ainsi qu’une configuration plus avancée.
