...
Dans le menu de gauche, accédez à **Fragments**. Faites glisser l’en-tête que vous avez créé précédemment dans l’exercice 3.2.2 sur le premier composant de la zone de travail. Faites glisser le pied de page que vous avez créé précédemment dans l’exercice 3.2.2 sur le dernier composant de la zone de travail.
...
Tout d’abord, supprimez **xxx** dans votre code d’HTML.
...
Ce code d’HTML contient 2 références à **xxx**. Vous devez maintenant remplacer chaque **xxx** par une référence à l’objet productListItems qui fait partie de l’événement qui déclenche le parcours.

![Journey Optimizer](./images/oc69.png)

Tout d’abord, supprimez la première **xxx** dans votre code d’HTML.
...
Tu auras alors ceci. Supprimez maintenant le deuxième **xxx** dans votre code d’HTML.
