...
1. Suivez les étapes pour [basculer la bibliothèque de balises](validate-with-debugger.md#use-the-experience-platform-debugger-to-map-to-your-tag-property) sur le [site de démonstration Luma](https://newluma.enablementadobe.com/category-men.html) vers la propriété de balise Web SDK à laquelle vous avez mappé votre propriété de transfert d’événement dans le flux de données.
