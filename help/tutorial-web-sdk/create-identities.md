---
title: Capturer des identités pour Platform Web SDK
description: Découvrez comment capturer des identités dans XDM et utiliser l’élément de données Mappage d’identités pour capturer des identifiants d’utilisateur. Cette leçon fait partie du tutoriel Implémentation d’Adobe Experience Cloud avec le SDK web.
...
>[!NOTE]
>
> Vous n’avez aucune action à effectuer pour capturer l’ECID dans une implémentation de Web SDK. Il est capturé automatiquement.
