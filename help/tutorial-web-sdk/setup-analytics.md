...
1. Sous **[!UICONTROL chemin est égal à]** définissez `/` `OR` `/index.html`. Pour le site web de démonstration Luma, cela garantit que la règle ne se déclenche que sur la page d’accueil
...
1. Accédez au site web de démonstration [Luma](https://luma.enablementadobe.com){target="_blank"}.
...
Vous avez configuré ci-dessus un remplacement de flux de données pour la page d’accueil [Luma](https://luma.enablementadobe.com).  Pour valider cette configuration
...
Accédez à une page produit telle que la [page produit Livingston All-purpose Tight](https://luma.enablementadobe.com/product.html?id=LLMP09).  Vérifiez que les pages vues du contenu sont capturées par Analytics.
...
1. Ajouter [Marco Lightweight Active Hoodie](https://luma.enablementadobe.com/product.html?id=LLMH13) au panier
1. Accédez à la [Page du panier](https://luma.enablementadobe.com/cart.html), puis vérifiez Edge Trace pour
