...
Lorsque vous générez du trafic sur le [site de démonstration Luma](https://luma.enablementadobe.com) mappé à votre propriété de balise, les données renseignent le jeu de données dans Experience Platform.
...
1. Ouvrez le site de démonstration [Luma](https://luma.enablementadobe.com) et sélectionnez l’icône de l’extension [!UICONTROL Experience Platform Debugger]
