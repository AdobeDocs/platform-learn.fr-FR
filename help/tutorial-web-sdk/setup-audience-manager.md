...
1. Ouvrez la [page d’accueil Luma](https://luma.enablementadobe.com) (mappée à votre propriété de balise) et l’**Adobe Experience Platform Debugger**, puis actualisez la page.
...
1. Ouvrez la page d’accueil du site web de démonstration [Luma](https://luma.enablementadobe.com) avec celle-ci mappée à votre propriété de balise pour remplir les critères du segment que vous venez de créer.
