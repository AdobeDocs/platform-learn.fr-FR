...
# 11.2 Connexion des jeux de données Adobe Experience Platform dans Customer Journey Analytics
...
## 11.2.2 Sélection de jeux de données Adobe Experience Platform
...
## 11.2.3 Identifiant de personne et assemblage de données
...
Étape suivante : [11.3 Création d’une vue de données](./ex3.md)
