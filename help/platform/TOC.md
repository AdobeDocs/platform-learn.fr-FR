...
+ Audiences et segmentation {#audiences}
   ...
   + Tutoriels{#audience-tutorials}
      ...
      + [Création d’un jeu de données pour exporter des données](https://experienceleague.adobe.com/fr/docs/experience-platform/segmentation/tutorials/create-dataset-export-segment){target="_blank"}
...
+ Hygiène des données {#data-hygiene}
   ...
   + [Mise à jour d’un attribut de profil](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/profiles/update-a-specific-attribute-with-upsert)
+ Ingestion de données {#data-ingestion}
   ...
   + [Ingérer des données à partir de l’espace de stockage dans le cloud](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/sources/ingest-data-from-cloud-storage)
   ...
   + [Diffuser des données en continu avec l’API HTTP](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api)
   + [Diffusion de données en continu à l’aide des connecteurs Source](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/sources/streaming-ingestion-source-connector)
...
+ Intégrations Experience Cloud {#experience-cloud}
   ...
   + [Cible](https://experienceleague.adobe.com/fr/docs/platform-learn/tutorials/destinations/target/next-hit-personalization)
