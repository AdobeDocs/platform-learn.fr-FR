...
description: Une fois qu’un segment partagé avec un partenaire de données a été connecté, vous pouvez explorer et commencer à partager des données avec des partenaires. Cette vidéo vous guide tout au long du processus de ... (Les descriptions doivent comporter entre 60 et 160 caractères).
feature: Segments
role: User
level: Intermediate
jira: KT-10248
