...
## 2.1.5.1 Donner un style à votre bloc
...
![Bloquer](./images/blockadv10.png)

Vous devriez alors voir ceci. Cliquez sur **Push origin**.

![Bloquer](./images/blockadv11.png)
...
![Bloquer](./images/blockadv13.png)

## 2.1.5.2 Ajouter une logique et charger des données à partir d’un point d’entrée externe

Pour cet exercice, vous allez effectuer une configuration « brute » de Web SDK d’Adobe et vous allez demander la meilleure offre suivante à Adobe Journey Optimizer Offer Decisioning.
...
La bibliothèque **alloy.js** est la bibliothèque de Web SDK qui permet d’envoyer des requêtes d’un site web à l’Edge Network d’Adobe, et de là, à des applications comme Adobe Experience Platform, Adobe Analytics, Adobe Target, etc.
...
![Bloquer](./images/blockadv15.png)

Vous devriez maintenant avoir ceci.

![Bloquer](./images/blockadv14.png)
...
Ce bloc de code est utilisé pour récupérer la valeur de l’identifiant Experience Cloud (ECID). L’ECID est l’identifiant d’appareil unique de votre navigateur.
...
Dans la requête, 2 **portées de décision** sont spécifiées, ce qui demandera à l’Offer decisioning Adobe Journey Optimizer de fournir une décision sur l’offre qui doit être vue par cet ECID.
...
![Bloquer](./images/blockadv18.png)

Cliquez ensuite sur **Origine push**.

![Bloquer](./images/blockadv19.png)
