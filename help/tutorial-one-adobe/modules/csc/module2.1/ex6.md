...
## 2.1.6.1 Ajouter le module externe à votre référentiel
...
Sous **const AUDIENCES = {...};** le code ci-dessous :
...
## 2.1.6.4 l’extension ACDL dans la propriété Tags
...
## 2.1.6.5 Envoyer des données à Adobe Experience Platform Edge Network
...
## 2.1.6.6 Afficher le profil client dans Adobe Experience Platform
