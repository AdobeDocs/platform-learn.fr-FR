...
# 3.3.3 Préparez la propriété du client de collecte de données Adobe Experience Platform et la configuration de Web SDK pour Offer Decisioning
...
Dans cet exercice, vous devez configurer ce **flux de données** pour qu’il fonctionne avec **Offer Decisioning**.
...
Pour activer **Offer Decisioning**, cochez la case **Offer Decisioning**. Cliquez sur **Enregistrer**.
...
La ligne 17 s’applique à l’image renvoyée par Offer Decisioning sur le site web. Cliquez sur **[!UICONTROL Enregistrer]**.
...
Grâce à cette modification, cette règle de la collecte de données Adobe Experience Platform écoute désormais la réponse d’Offer Decisioning qui fait partie de la réponse de Web SDK. Lorsque la réponse est reçue, l’image de l’offre s’affiche sur la page d’accueil.
...
- 1 Implémentation d&#39;Offer Decisioning à l&#39;aide de votre propriété Collecte de données
...
Accédez à [3.3.4 Combiner Adobe Target et Offer Decisioning](./ex4.md){target="_blank"}
