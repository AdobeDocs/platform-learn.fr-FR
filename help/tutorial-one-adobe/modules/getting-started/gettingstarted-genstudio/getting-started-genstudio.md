---
title: Prise en main - Agentic AI
description: Prise en main - Agentic AI
kt: 5342
doc-type: tutorial
...
# Prise en main - GenStudio

Dans ce module, vous allez tout configurer pour que votre environnement et votre ordinateur soient prêts à commencer à utiliser les GenStudio Tech Labs.

## Objectifs d’apprentissage

- Découvrez comment configurer l’extension Chrome
- Configurez votre projet Adobe I/O et Postman ou Postbuster
- Installation des applications nécessaires pour exécuter les GenStudio Tech Labs
...
[Configuration de votre projet Adobe I/O](./ex2.md)
...
[Option 1 : configuration de Postman](./ex3.md)
...
[Option 2 : configuration de PostBuster](./ex4.md)
...
[Applications à installer](./ex5.md)
