...
Les applications suivantes doivent être installées sur votre ordinateur avant de suivre ce tutoriel :

- Adobe Creative Cloud
- Photoshop 2025
- Postman

## 1. Installer l’extension Chrome pour la documentation de l’Experience League

### À propos de l’extension Chrome

La documentation a été rendue générique afin qu’elle puisse être facilement réutilisée par n’importe qui, à l’aide de n’importe quelle instance d’Adobe.
...
| Nom | Clé |
|:-------------:| :---------------:|
| Identifiant de l’organisation IMS | `--aepImsOrgId--` |
