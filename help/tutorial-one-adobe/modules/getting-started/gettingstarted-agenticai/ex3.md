...
Votre programme AEM utilise le numéro qui vous a été attribué à son nom. Le nom de votre programme AEM doit être l’un des suivants :
...
Pour accéder à votre site web, vous pouvez utiliser les URL suivantes par défaut :
...
En outre, un nom de domaine personnalisé a été créé pour chaque site web. Vous pouvez y accéder à l’aide de cette URL :
