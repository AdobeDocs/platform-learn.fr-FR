...
# Prise en main - Agentic AI

Dans ce module, vous allez tout configurer pour que votre environnement et votre ordinateur soient prêts à commencer à utiliser les laboratoires d’IA d’Agentic.

## Objectifs d’apprentissage

- Découvrez comment configurer l’extension Chrome
- Découvrez comment utiliser le site web
- Installation des applications nécessaires pour utiliser Agentic AI Labs
...
[Applications à installer](./ex2.md)
...
[Utiliser votre site web AEM et votre sandbox AEP](./ex3.md)
