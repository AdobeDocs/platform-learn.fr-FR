...
+ 1 {#production} Création et production
   + 1.1 Aperçu de la {#module11} des services d&#39;Adobe Firefly
      ...
      + [1.1.3 Utilisation des API Photoshop](/help/tutorial-one-adobe/modules/creative-cloud/module1.1/ex3.md)
...
+ 3 {#activation} de diffusion et d’activation
   ...
   + 3.2 Adobe Journey Optimizer : {#module32} des services de traduction
      ...
      + [3.2.1 Fournisseur De Traductions](/help/tutorial-one-adobe/modules/uce/module3.2/ex1.md)
      + [3.2.2 Création de votre campagne](/help/tutorial-one-adobe/modules/uce/module3.2/ex2.md)
      + [3.2.3 Ajouter des langues à votre e-mail](/help/tutorial-one-adobe/modules/uce/module3.2/ex3.md)
