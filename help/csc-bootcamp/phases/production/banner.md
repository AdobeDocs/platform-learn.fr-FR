---
title: Bootcamp de SC - Créer une bannière de page d’accueil de produit
description: Bootcamp de SC - Créer une bannière de page d’accueil de produit
...
- Sur la page d’accueil, accédez à Outils > Ressources > Profils de traitement.

![Outils > Ressources > Profils de traitement](./images/prod-processing-profiles.png)
...
- Les éléments suivants vous intéressent :
   ...
   - Adobe Banner Light : crée une bannière Adobe avec une superposition légère en fonction de la ressource sélectionnée.
      ![bannière lumineuse](./images/prod-banner-light.jpg)
   - Bannière publicitaire Adobe Green : crée une bannière Adobe vélo avec une superposition verte, en fonction de la ressource sélectionnée.
...
![créer des détails sur le dossier](./images/prod-profile-folder-details.png)

- Après avoir créé le dossier, cochez la case en regard de son nom, puis cliquez sur le bouton &quot;Appliquer&quot; en haut à droite.

![s’appliquer au dossier créé](./images/prod-select-profile-folder.png)

Maintenant que nous avons effectué la configuration nécessaire, générons notre bannière.

- Cliquez sur le logo AEM dans le coin supérieur gauche pour ouvrir la navigation, puis accédez à Navigation > Ressources > Fichiers .

![écran d’accueil d’aem](./images/prod-select-assets.png)
![écran aem assets](./images/prod-select-assets-2.png)

- Recherchez le dossier &quot;Ressources Adobe générées&quot; et ouvrez-le en cliquant sur la carte. C’est là que les bannières générées s’affichent.
...
![charger par glisser-déposer](./images/prod-drag-drop-banner.png)

![charger à l’aide de la fonction créer un fichier](./images/prod-create-file.png)
...
> ![remplacer existant](./images/prod-replace-asset.png)

Nous avons maintenant notre bannière générée que nous pourrons utiliser ultérieurement lors de la diffusion de notre campagne. Veillez à publier la bannière en la sélectionnant, puis en cliquant sur le bouton &quot;Publication rapide&quot; du ruban.

![publication de ressource](./images/prod-publish-banner.png)

## Suivi dans Workfront

Si vous avez besoin d’un processus de révision et d’approbation formel et auditable de vos ressources, Workfront est l’endroit idéal.
...
![bannière d’opt-out](./images/banner-gonogo.png)
...
![tâche workfront](./images/wf-proof-task.png)
...
- Après avoir cliqué sur la notification, ils devront faire face à votre BAT et pourront faire quelques commentaires et/ou valider ce BAT.
   ...
   ![Commentaire point d’insertion](./images/wf-proof-comment.png)
   ...
   ![charger une nouvelle version](./images/wf-upload-version.png)
   ...
   ![lier la ressource](./images/wf-link-new-asset.png)
   ...
   ![comparaison des BAT](./images/wf-proof-compare.png)

   ![prendre une décision](./images/make-decision-proof.png)

   ![approuvé](./images/approved.png)
...
Étape suivante : [Phase 2 - Production : Créer une publicité sur les médias sociaux](./social.md)

[Revenir à la phase 1 - Planification : Autres prétâches](../planning/prework.md)
